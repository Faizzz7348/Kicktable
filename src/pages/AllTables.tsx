          ...
          {region === "selangor" && (
            <div className="relative group">
              ...
              <img 
                src={SelangorIcon} 
                alt="Selangor Flag" 
                className="h-14 w-20 object-cover rounded-lg border-2 border-gray-300/50 dark:border-gray-700 shadow-md transition-transform duration-300 group-hover:scale-105" 
                style={{ 
